...
The `[GENERATE LoRA DATA]` button opens a sub-panel to auto-generate training pairs for this entity using the Codex API, ready for Unsloth training.
...
### Framework
**React + Vite** (single file for Codex initial prototype, then split if needed).
...
Codex should build in this sequence:
